...
public final class WebhookUtils {
    ...
    // Tipos de eventos de webhook assináveis (alinhados ao backend).
    // Envelope entregue: { id, type, data, timestamp, subscription }.
    ...
    public static final String EVENT_TRANSACTION_COMPLETED      = "transaction.completed";
    ...
    public static final String EVENT_BALANCE_UPDATED            = "balance.updated";
    public static final String EVENT_SUBSCRIPTION_CANCELLED     = "subscription.cancelled";
    public static final String EVENT_KYC_SUBMITTED              = "kyc.submitted";
    public static final String EVENT_KYC_APPROVED               = "kyc.approved";
    public static final String EVENT_KYC_REJECTED               = "kyc.rejected";
    public static final String EVENT_ADVANCE_CREATED            = "advance.created";
    public static final String EVENT_ADVANCE_APPROVED           = "advance.approved";
    public static final String EVENT_ADVANCE_REJECTED           = "advance.rejected";
    public static final String EVENT_WITHDRAWAL_REQUESTED       = "withdrawal.requested";
